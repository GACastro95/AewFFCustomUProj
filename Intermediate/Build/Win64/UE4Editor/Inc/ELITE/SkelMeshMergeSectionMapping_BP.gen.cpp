...
#include "ELITE/Public/SkelMeshMergeSectionMapping_BP.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSkelMeshMergeSectionMapping_BP() {}
...
class UScriptStruct* FSkelMeshMergeSectionMapping_BP::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ELITE_API uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP, Z_Construct_UPackage__Script_ELITE(), TEXT("SkelMeshMergeSectionMapping_BP"), sizeof(FSkelMeshMergeSectionMapping_BP), Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash());
	}
	return Singleton;
}
template<> ELITE_API UScriptStruct* StaticStruct<FSkelMeshMergeSectionMapping_BP>()
{
	return FSkelMeshMergeSectionMapping_BP::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSkelMeshMergeSectionMapping_BP(FSkelMeshMergeSectionMapping_BP::StaticStruct, TEXT("/Script/ELITE"), TEXT("SkelMeshMergeSectionMapping_BP"), false, nullptr, nullptr);
static struct FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP
{
	FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP()
	{
		UScriptStruct::DeferCppStructOps<FSkelMeshMergeSectionMapping_BP>(FName(TEXT("SkelMeshMergeSectionMapping_BP")));
	}
} ScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeSectionMapping_BP;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/SkelMeshMergeSectionMapping_BP.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Statics::NewProp_SectionIDs_MetaData[] = {
		...
		{ "Category", "SkelMeshMergeSectionMapping_BP" },
		{ "ModuleRelativePath", "Public/SkelMeshMergeSectionMapping_BP.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP_Hash() { return 3808461609U; }
