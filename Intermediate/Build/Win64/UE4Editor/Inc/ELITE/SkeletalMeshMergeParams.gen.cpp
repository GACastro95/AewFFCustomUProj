...
#include "ELITE/Public/SkeletalMeshMergeParams.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ELITE_API UScriptStruct* Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_BP();
	ELITE_API UScriptStruct* Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping();
...
class UScriptStruct* FSkeletalMeshMergeParams::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ELITE_API uint32 Get_Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkeletalMeshMergeParams, Z_Construct_UPackage__Script_ELITE(), TEXT("SkeletalMeshMergeParams"), sizeof(FSkeletalMeshMergeParams), Get_Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Hash());
	}
	return Singleton;
}
template<> ELITE_API UScriptStruct* StaticStruct<FSkeletalMeshMergeParams>()
{
	return FSkeletalMeshMergeParams::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSkeletalMeshMergeParams(FSkeletalMeshMergeParams::StaticStruct, TEXT("/Script/ELITE"), TEXT("SkeletalMeshMergeParams"), false, nullptr, nullptr);
static struct FScriptStruct_ELITE_StaticRegisterNativesFSkeletalMeshMergeParams
{
	FScriptStruct_ELITE_StaticRegisterNativesFSkeletalMeshMergeParams()
	{
		UScriptStruct::DeferCppStructOps<FSkeletalMeshMergeParams>(FName(TEXT("SkeletalMeshMergeParams")));
	}
} ScriptStruct_ELITE_StaticRegisterNativesFSkeletalMeshMergeParams;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::NewProp_PostProcessAnimBlueprint_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "SkeletalMeshMergeParams" },
		{ "ModuleRelativePath", "Public/SkeletalMeshMergeParams.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::NewProp_PostProcessAnimBlueprint = { "PostProcessAnimBlueprint", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSkeletalMeshMergeParams, PostProcessAnimBlueprint), Z_Construct_UClass_UAnimInstance_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::NewProp_PostProcessAnimBlueprint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::NewProp_PostProcessAnimBlueprint_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Statics::NewProp_PostProcessAnimBlueprint,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkeletalMeshMergeParams_Hash() { return 551348799U; }
