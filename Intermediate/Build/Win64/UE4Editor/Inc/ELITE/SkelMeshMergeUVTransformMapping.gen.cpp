...
#include "ELITE/Public/SkelMeshMergeUVTransformMapping.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ELITE_API UScriptStruct* Z_Construct_UScriptStruct_FSkelMeshMergeUVTransform();
...
class UScriptStruct* FSkelMeshMergeUVTransformMapping::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ELITE_API uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping, Z_Construct_UPackage__Script_ELITE(), TEXT("SkelMeshMergeUVTransformMapping"), sizeof(FSkelMeshMergeUVTransformMapping), Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Hash());
	}
	return Singleton;
}
template<> ELITE_API UScriptStruct* StaticStruct<FSkelMeshMergeUVTransformMapping>()
{
	return FSkelMeshMergeUVTransformMapping::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSkelMeshMergeUVTransformMapping(FSkelMeshMergeUVTransformMapping::StaticStruct, TEXT("/Script/ELITE"), TEXT("SkelMeshMergeUVTransformMapping"), false, nullptr, nullptr);
static struct FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransformMapping
{
	FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransformMapping()
	{
		UScriptStruct::DeferCppStructOps<FSkelMeshMergeUVTransformMapping>(FName(TEXT("SkelMeshMergeUVTransformMapping")));
	}
} ScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransformMapping;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Hash() { return 1933117150U; }
