...
#include "ELITE/Public/SkelMeshMergeUVTransform.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FSkelMeshMergeUVTransform::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ELITE_API uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransform_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeUVTransform, Z_Construct_UPackage__Script_ELITE(), TEXT("SkelMeshMergeUVTransform"), sizeof(FSkelMeshMergeUVTransform), Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransform_Hash());
	}
	return Singleton;
}
template<> ELITE_API UScriptStruct* StaticStruct<FSkelMeshMergeUVTransform>()
{
	return FSkelMeshMergeUVTransform::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSkelMeshMergeUVTransform(FSkelMeshMergeUVTransform::StaticStruct, TEXT("/Script/ELITE"), TEXT("SkelMeshMergeUVTransform"), false, nullptr, nullptr);
static struct FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransform
{
	FScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransform()
	{
		UScriptStruct::DeferCppStructOps<FSkelMeshMergeUVTransform>(FName(TEXT("SkelMeshMergeUVTransform")));
	}
} ScriptStruct_ELITE_StaticRegisterNativesFSkelMeshMergeUVTransform;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkelMeshMergeUVTransform_Hash() { return 1434638181U; }
