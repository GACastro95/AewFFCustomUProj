...
void UELCustomSearchObjCAM::GetMenuData(const UDataTable* _MenuTable, const UDataTable* _MenuDetailTable, const TArray<int32>& _InCategory, TArray<int32>& _outCategory) {
}
