...
#include "ECareerCutSceneState.h"
#include "ECareerCutsceneExtraInfo.h"
#include "ECareerCutsceneMessageCastType.h"
#include "ECareerRingObject.h"
#include "ELCareerCutSceneManager.generated.h"

class ACineCameraActor;
class AELCareerSequencePlayerBase;

UCLASS(Blueprintable)
class ABP_200508_API AELCareerCutSceneManager : public AActor, public IELControllableInterface {
    GENERATED_BODY()
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetCutSceneMessageIndex(int32 Index, ECareerCutsceneMessageCastType MessageCast, ECareerCutsceneExtraInfo ExtraInfo);
    
    UFUNCTION(BlueprintCallable)
    void SetCutSceneMessage(FName MessageKey, ECareerCutsceneMessageCastType MessageCast, ECareerCutsceneExtraInfo ExtraInfo);
    
    UFUNCTION(BlueprintCallable)
    void SetCameraHeightCorrection(ACineCameraActor* pCineCameraActor, float CameraHeight, float CameraBlendTime);
