...
enum class EELVictoryCutsceneType : uint8 {
    ...
    Tag_Mixed_Normal,
    Tag_Mixed_Champion,
    Single_Male_Normal_EBWD,
    Single_Female_Normal_EBWD,
    Single_Male_Champion_EBWD,
    Single_Female_Champion_EBWD,
    Tag_Male_Normal_EBWD,
    Tag_Female_Normal_EBWD,
    Tag_Male_Champion_EBWD,
    Tag_Female_Champion_EBWD,
