...
AELSSStationalCamera::AELSSStationalCamera(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
bool AELSSStationalCamera::CheckCollision(const FVector& inTargetLocation, const FTransform& inBaseTransform, int32 inLocatorId, float inCurrentLocatorTime) {
    return false;
}
