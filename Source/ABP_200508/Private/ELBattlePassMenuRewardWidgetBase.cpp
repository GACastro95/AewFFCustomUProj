...
void UELBattlePassMenuRewardWidgetBase::MoveCursorForMouse(bool IsLeft) {
}

void UELBattlePassMenuRewardWidgetBase::GetNextBattePassRewardItemList(bool _isMoveLeft, TArray<FBattlePassRewardMenuParam>& _centerItemList, TArray<FBattlePassRewardMenuParam>& _leftItemList, TArray<FBattlePassRewardMenuParam>& _rightItemList) {
}

int32 UELBattlePassMenuRewardWidgetBase::GetKeyRepeatCount() {
    return 0;
}
