...
AELSSPlayer::AELSSPlayer(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer.SetDefaultSubobjectClass<UELSSCharacterMovementComponent>(TEXT("CharMoveComp"))) {
    ...
    this->bModifiedVehicleCollisionResponse = false;
    this->ForceIgnoreVehicleCollisionResponseTime = 0.00f;
    this->CostumeID = 0;
    ...
    this->DisableSyncHeightRate = 0.00f;
...
float AELSSPlayer::GetDisableSyncHeightRate() const {
    return 0.0f;
}
