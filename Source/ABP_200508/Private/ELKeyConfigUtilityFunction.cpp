...
bool UELKeyConfigUtilityFunction::IsValidKeyMapData(FKeyMapSettingData& targetData) {
    return false;
}

void UELKeyConfigUtilityFunction::GetDefaultSSModeKeyMapSettingData(bool _isGamepad, TArray<FKeyMapSettingData>& _outResult) {
}

void UELKeyConfigUtilityFunction::GetDefaultKeyMapSettingData(bool _isGamepad, TArray<FKeyMapSettingData>& _outResult) {
}
