...
void UMovesPlayerStart::GetMovesPlayerStartArray(TArray<AELMovesPlayerPosition*>& _outList, const TArray<AELMovesPlayerPosition*>& _Array, EMovesCategory Category) {
}
