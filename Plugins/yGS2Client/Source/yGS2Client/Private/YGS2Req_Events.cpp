...
void UYGS2Req_Events::SetBinaryData(const FString& _strBinary, const FString& _strExtension, const FString& _strMimeType) {
}

FString UYGS2Req_Events::GetResultID() const {
    return TEXT("");
}
