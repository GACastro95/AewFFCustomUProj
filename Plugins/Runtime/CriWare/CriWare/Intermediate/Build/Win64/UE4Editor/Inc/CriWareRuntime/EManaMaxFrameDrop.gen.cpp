...
// End Cross Module References
	static UEnum* EManaMaxFrameDrop_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_CriWareRuntime_EManaMaxFrameDrop, Z_Construct_UPackage__Script_CriWareRuntime(), TEXT("EManaMaxFrameDrop"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EManaMaxFrameDrop(EManaMaxFrameDrop_StaticEnum, TEXT("/Script/CriWareRuntime"), TEXT("EManaMaxFrameDrop"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_CriWareRuntime_EManaMaxFrameDrop_Hash() { return 4232563114U; }
	UEnum* Z_Construct_UEnum_CriWareRuntime_EManaMaxFrameDrop()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_CriWareRuntime();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EManaMaxFrameDrop"), 0, Get_Z_Construct_UEnum_CriWareRuntime_EManaMaxFrameDrop_Hash(), false);
#else
