...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAtomBusSampler_PauseRecording_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AtomBusSampler.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAtomBusSampler_PauseRecording_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAtomBusSampler, nullptr, "PauseRecording", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAtomBusSampler_PauseRecording_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAtomBusSampler_PauseRecording_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAtomBusSampler_PauseRecording()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAtomBusSampler_PauseRecording_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::NewProp_Milliseconds = { "Milliseconds", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AtomBusSampler_eventPlayRecordedSound_Parms, Milliseconds), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::NewProp_Milliseconds,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAtomBusSampler, nullptr, "PlayRecordedSound", nullptr, nullptr, sizeof(AtomBusSampler_eventPlayRecordedSound_Parms), Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound_Statics::Function_MetaDataParams)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAtomBusSampler_ResumeRecording_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AtomBusSampler.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAtomBusSampler_ResumeRecording_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAtomBusSampler, nullptr, "ResumeRecording", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAtomBusSampler_ResumeRecording_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAtomBusSampler_ResumeRecording_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAtomBusSampler_ResumeRecording()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAtomBusSampler_ResumeRecording_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InBusName_MetaData[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAtomBusSampler_StartRecording_Statics::NewProp_InBusName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAtomBusSampler_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAtomBusSampler_CanPlayRecordedSound, "CanPlayRecordedSound" }, // 1347932341
		{ &Z_Construct_UFunction_UAtomBusSampler_CanRecord, "CanRecord" }, // 1122977690
		{ &Z_Construct_UFunction_UAtomBusSampler_FinishRecording, "FinishRecording" }, // 2081202445
		{ &Z_Construct_UFunction_UAtomBusSampler_IsPausedRecordedSound, "IsPausedRecordedSound" }, // 314870720
		{ &Z_Construct_UFunction_UAtomBusSampler_IsPlayingRecordedSound, "IsPlayingRecordedSound" }, // 4008059554
		{ &Z_Construct_UFunction_UAtomBusSampler_IsRecording, "IsRecording" }, // 3196596087
		{ &Z_Construct_UDelegateFunction_UAtomBusSampler_OnRecordingFinished__DelegateSignature, "OnRecordingFinished__DelegateSignature" }, // 827548928
		{ &Z_Construct_UDelegateFunction_UAtomBusSampler_OnRecordingStarted__DelegateSignature, "OnRecordingStarted__DelegateSignature" }, // 382819490
		{ &Z_Construct_UFunction_UAtomBusSampler_PauseRecordedSound, "PauseRecordedSound" }, // 2044853609
		{ &Z_Construct_UFunction_UAtomBusSampler_PauseRecording, "PauseRecording" }, // 243132009
		{ &Z_Construct_UFunction_UAtomBusSampler_PlayRecordedSound, "PlayRecordedSound" }, // 2140366052
		{ &Z_Construct_UFunction_UAtomBusSampler_ResumeRecording, "ResumeRecording" }, // 1556806753
		{ &Z_Construct_UFunction_UAtomBusSampler_StartRecording, "StartRecording" }, // 1418539090
		{ &Z_Construct_UFunction_UAtomBusSampler_StopRecordedSound, "StopRecordedSound" }, // 2104698309
		{ &Z_Construct_UFunction_UAtomBusSampler_StopRecordedSoundWithoutReleaseTime, "StopRecordedSoundWithoutReleaseTime" }, // 2956657244
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAtomBusSampler_Statics::NewProp_OnRecordingStarted = { "OnRecordingStarted", nullptr, (EPropertyFlags)0x0010000010080005, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAtomBusSampler, OnRecordingStarted), Z_Construct_UDelegateFunction_UAtomBusSampler_OnRecordingStarted__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAtomBusSampler_Statics::NewProp_OnRecordingStarted_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAtomBusSampler_Statics::NewProp_OnRecordingStarted_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAtomBusSampler, 2017620147);
