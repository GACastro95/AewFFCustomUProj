...
static struct FScriptStruct_CriWareRuntime_StaticRegisterNativesFAtomSelectorSettingsParam
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAtomSelectorSettingsParam>(FName(TEXT("AtomSelectorSettingsParam")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAtomSelectorSettingsParam, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_DefaultSelectorLabel = { "DefaultSelectorLabel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAtomSelectorSettingsParam, DefaultSelectorLabel), METADATA_PARAMS(Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_DefaultSelectorLabel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Statics::NewProp_DefaultSelectorLabel_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtomSelectorSettingsParam_Hash() { return 387629430U; }
